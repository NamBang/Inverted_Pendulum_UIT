...
extern __IO int32_t count_temp1,count;
...
//		{
//			RMP = (float)(((count_recent1-count_update1)/1320.0)*6000.0);//timer ngat 100 ms, 
//		}
//		else if (count_recent1 < count_update1)
//		{
//			RMP = 0 -((float)(((count_recent1-count_update1)/1320.0)*6000.0));
//		}
//		else if (count_recent1 == count_update1)
//		{
//			RMP=0.0;
